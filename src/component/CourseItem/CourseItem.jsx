  ...
  return (
    ...
    >
      <Link to={`/course/${url}`} state={state}>
        <div
          className={`flex zoom-in items-center justify-center p-12 mb-2 h-60 w-full mx-auto bg-pink-50 rounded-xl`}
        >
          <img
            src={course.image}
        ...
        <div className="py-3">
          ...
          {status && (
            <div>
              ...
              <div className="w-full bg-slate-300 h-1 rounded-sm">
                <div className="w-6 bg-main dark:bg-sky-500 h-full"></div>
              </div>
              <div className="flex gap-1">
                <span className="dark:text-slate-300">6%</span>
                <span className="dark:text-slate-300">tamamlandı</span>
              </div>
            </div>
          )}
          {coursePreview && (
