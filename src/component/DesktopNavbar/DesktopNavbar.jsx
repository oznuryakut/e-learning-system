    ...
    <>
      ...
      <ul className="hidden lg:flex space-x-8 items-center">
        <li>
          <NavLink
            to="/"
            className="hover:text-main dark:hover:text-white
      ...
      <div className="flex items-center">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex items-center gap-2">
            {user ? (
              <>
                <li className="bg-main dark:bg-white profile h-10 w-10 flex items-center justify-center rounded-full cursor-pointer">
                  <Link
                ...
                <ul className="hidden info absolute bg-white dark:bg-slate-900 shadow-md dark:shadow-slate-600 h-auto w-52 top-16 right-20 rounded">
                  ...
                  <div className="flex px-3 gap-4 items-center py-4 ">
                    <div className="bg-main dark:bg-white profile h-10 w-10 flex items-center justify-center rounded-full cursor-pointer">
                      <Link
              ...
              <>
                <Link
                  ...
                  className="text-md font-medium text-main border py-2 
                        px-4 border-main dark:border-sky-500 dark:text-white rounded-lg 
          ...
          >
            <div
              className="text-xl text-main dark:text-white"
              onClick={darkMode}
            >
          ...
          >
            {Toggle ? (
              <FaTimes className="text-xl text-main dark:text-white" />
            ) : (
              <FaBars
