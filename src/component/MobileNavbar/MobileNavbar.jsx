        ...
        >
          ...
          {user ? (
            <>
              <div className="flex pl-5 pr-20 gap-4 items-center border-b py-4 dark:border-slate-500 bg-neutral-200 dark:bg-slate-800">
                ...
                <div>
                  ...
                  <p className="dark:text-slate-300">tekrar hoşgeldin!</p>
                </div>
              </div>
              <div className="flex flex-col pl-5 pr-20 gap-y-1 border-b dark:border-slate-500 py-4">
                ...
                <Link
                  ...
                  className="duration-300 hover:text-main capitalize dark:text-slate-400 dark:hover:text-white"
                >
                  Öğrenimlerim
                </Link>
              </div>
            ...
            <div className="flex flex-col pl-5 pr-20 gap-y-1 border-b dark:border-slate-500 py-4">
              <Link
                to="/log-in"
                className="text-main dark:text-white text-md "
                onClick={handleToggle}
              >
                Giriş Yap
              </Link>
          ...
          {user && (
            <div className="pl-5 pr-20 border-t dark:border-slate-500 pt-4">
              ...
              >
                ...
                <span className="dark:text-white capitalize">çıkış yap</span>
              </Link>
            </div>
          )}
        </div>
